...
export default function EditBatchPage() {
  ...
  // The BatchForm's onSubmit expects data without id, candlingResults, tasks, hatchedEggs.
  // We merge these back in before calling updateBatch.
  const handleSubmit = (data: Omit<Batch, 'id' | 'candlingResults' | 'tasks' | 'hatchedEggs'> & { customCandlingDays?: number[] }) => {
    if (!batchToEdit) return;
    
    // Preserve existing candling results, tasks, and hatched eggs.
    // Tasks will be re-generated by updateBatch if startDate, speciesId, incubatorType or customCandlingDays change.
    const updatedBatchData: Batch = {
      ...batchToEdit, // This carries over existing candlingResults, tasks, hatchedEggs
      ...data,        // This overrides fields from the form
